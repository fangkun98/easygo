...
import com.fk.easygo.SearchApp;
import com.fk.easygo.client.GoodsClient;
...
public class TestES {
    ...
    public void testAddDocument(){
        ...
        for (Goods goods : goodsList) {
            ...
            //需要把商品数据，新增到索引库，调用ES的API....
        }
        goodsService.saveDocuments(goodsList);
        System.out.println("批量新增数据库成功");
    ...
    public void testgetDocumentById(){
        Goods goods = goodsService.getDocumentById(149187842867935L);
    ...
    public void testDeleteByid(){
        goodsService.deleteDocumentById(149187842867950L);
