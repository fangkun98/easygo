...
import com.fk.easygo.utils.AttributeNameObject;
import com.fk.easygo.utils.JsonUtils;
import com.fk.easygo.utils.OrderUrl;
import com.fk.easygo.utils.SkuBean;
...
//        Goods goods = goodsClient.getGoodsById(149187842868052L);
        ...
        //4.设置静态页面生成的文件地址
        FileWriter fileWriter=new FileWriter("E:/TEST/"+goods.getId()+".html");
        //5.创建Context对象
